...
RUN Rscript -e 'devtools::install_github("NEONScience/NEON-utilities/neonUtilities", dependencies=TRUE, force=TRUE)'

# remove preexisting items in server directory
RUN rm -rf /srv/shiny-server/* 

# get Calliope Shiny app, move into shiny-server
RUN git clone https://github.com/Danielslee51/Calliope-View.git && mv Calliope-View/* /srv/shiny-server/Calliope-View
